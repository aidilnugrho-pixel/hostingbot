-- ========== AUTO UFO (EXACT MATCH ZONE + BEST ZONE AT 56.00) ==========
...
-- ========== DATA NAMA ZONE (1-40) - NAMA HARUS PERSIS ==========
local zoneList = {
...
-- ========== DETECT ZONE (EXACT MATCH / FULL TEXT) ==========
local function detectZoneFromText(text)
    if not text then return nil, nil end
    local lowerText = string.lower(text)
    
    -- PRIORITAS: COCOKKAN SELURUH TEKS DENGAN NAMA ZONE
    ...
    -- KALAU TIDAK MATCH PERSIS, COBA COCOKKAN DENGAN PATTERN (FALLBACK)
    for _, zone in pairs(zoneList) do
...
local function processText(currentText)
    ...
    elseif isTargetTimer(currentText) then
        ...
        print("⏳ " .. currentText .. " → Bukan zone/target timer, diabaikan")
        lastUIText = currentText
    end
end
...
subTitleText.Text = "EXACT ZONE + BEST (56.00)"
...
lastTextCard.Size = UDim2.new(1, -20, 0, 55)
...
lastTextIcon.Size = UDim2.new(0, 35, 1, 0)
...
lastTextIcon.TextSize = 18
lastTextIcon.Parent = lastTextCard

local lastTextTitle = Instance.new("TextLabel")
lastTextTitle.Size = UDim2.new(1, -45, 0, 16)
lastTextTitle.Position = UDim2.new(0, 45, 0, 4)
...
lastTextValue.Size = UDim2.new(1, -45, 0, 28)
lastTextValue.Position = UDim2.new(0, 45, 0, 22)
...
statusCard.Position = UDim2.new(0, 10, 0, 72)
...
statusTitle.Size = UDim2.new(1, -45, 0, 16)
statusTitle.Position = UDim2.new(0, 45, 0, 4)
...
statusValue.Size = UDim2.new(1, -45, 0, 28)
statusValue.Position = UDim2.new(0, 45, 0, 22)
...
actionCard.Size = UDim2.new(1, -20, 0, 55)
actionCard.Position = UDim2.new(0, 10, 0, 134)
...
actionIcon.Size = UDim2.new(0, 35, 1, 0)
...
actionTitle.Size = UDim2.new(1, -45, 0, 16)
actionTitle.Position = UDim2.new(0, 45, 0, 4)
...
actionValue.Size = UDim2.new(1, -45, 0, 28)
actionValue.Position = UDim2.new(0, 45, 0, 22)
        ...
        if screenGui and screenGui.Parent then
            ...
            if currentText then
                ...
                elseif isTargetTimer(currentText) then
                    local colin = GetBestOpenZone()
                    local targetZone = colin + 1
                    statusValue.Text = "📍 Timer 56.00! Best Zone"
                    ...
                    statusValue.Text = "⏳ Bukan zone/target timer"
...
print("═══════════════════════════════════════════")
print("   AUTO UFO - EXACT ZONE MATCH")
print("═══════════════════════════════════════════")
print("📡 Membaca dari: PlayerGui.Root.UfoStatusRoot")
print("🎯 Teks harus PERSIS dengan nama zone")
print("   Contoh: 'Mushroom Forest' → Zone 10")
print("          'Mushroom Soup' → Zone 11")
print("📍 Timer 56.00 → Teleport ke Best Zone")
